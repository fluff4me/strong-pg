...
export type JoinColumns<TABLE1 extends TableSchema, TABLE2 extends TableSchema, TABLE1_NAME extends string, TABLE2_NAME extends string> = Schema.Column<TABLE1> extends infer TABLE1_COLUMNS extends string ? Schema.Column<TABLE2> extends infer TABLE2_COLUMNS extends string ? Exclude<TABLE1_COLUMNS, TABLE2_COLUMNS> | Exclude<TABLE2_COLUMNS, TABLE1_COLUMNS> extends infer COLUMNS_UNION ? COLUMNS_UNION | (TABLE1_NAME extends '' ? never : `${TABLE1_NAME}.${Exclude<TABLE1_COLUMNS, `${string}.${string}`>}`) | `${TABLE2_NAME}.${Exclude<TABLE2_COLUMNS, `${string}.${string}`>}` | Extract<TABLE1_COLUMNS, `${string}.${string}`> | Extract<TABLE2_COLUMNS, `${string}.${string}`> : never : never : never;
