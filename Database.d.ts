...
export default class Database<SCHEMA extends DatabaseSchema> {
    ...
    function<FUNCTION_NAME extends DatabaseSchema.FunctionName<SCHEMA>>(functionName: FUNCTION_NAME, ...params: FunctionParameters<DatabaseSchema.Function<SCHEMA, FUNCTION_NAME>>): FunctionCall<DatabaseSchema.Function<SCHEMA, FUNCTION_NAME>, SCHEMA, FUNCTION_NAME, Extract<import("./FunctionCall").FunctionOutput<SCHEMA, DatabaseSchema.Function<SCHEMA, FUNCTION_NAME>, FUNCTION_NAME>, import("./Schema").TableSchema>>;
}
