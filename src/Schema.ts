...
namespace Schema {
	...
	export type Columns<SCHEMA, PREFIX extends string = ""> = { [COLUMN in keyof SCHEMA as COLUMN extends keyof SpecialKeys<any> ? never : `${PREFIX}${COLUMN & string}`]: SCHEMA[COLUMN] };
